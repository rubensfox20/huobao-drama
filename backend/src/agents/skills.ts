...
const AGENT_SKILL_MAP: Record<string, string[]> = {
  ...
  extractor: ['extractor'],
  storyboard_breaker: ['ai-video-prompt-writer', 'storyboard_breaker', 'storyboard-attribute-extractor'],
  voice_assigner: ['voice_assigner'],
  grid_prompt_generator: ['ai-video-prompt-writer', 'grid_prompt_generator'],
}
