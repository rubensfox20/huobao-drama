...
export const episodes = sqliteTable('episodes', {
  ...
  episodeInSeason: integer('episode_in_season'),
  targetDurationSeconds: integer('target_duration_seconds'),
  targetPartCount: integer('target_part_count'),
  promptLanguage: text('prompt_language'),
  scriptLanguage: text('script_language'),
  cinematicStatus: text('cinematic_status'),
  createdAt: text('created_at').notNull(),
  updatedAt: text('updated_at').notNull(),
  deletedAt: text('deleted_at'),
})
...
export const storyboards = sqliteTable('storyboards', {
  ...
  panelCaption: text('panel_caption'),
  sceneSpeed: text('scene_speed'),
  title: text('title'),
  location: text('location'),
  time: text('time'),
  ...
  promptLayers: text('prompt_layers'),
  modelAdapters: text('model_adapters'),
...
export const assets = sqliteTable('assets', {
  ...
  referencePriority: text('reference_priority'),
