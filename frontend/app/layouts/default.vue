    ...
    <header class="header">
      <div class="header-left">
        <button class="brand" @click="navigateTo('/')">
          <div class="brand-mark">
            <img v-if="showBrandImage" :src="brandLogo" :alt="messages.shell.brandAlt" class="brand-logo" @error="showBrandImage = false" />
            <span v-else class="brand-fallback">{{ messages.shell.brandFallback }}</span>
          </div>
          <div class="brand-text">
            <span class="brand-name">{{ messages.shell.brandName }}</span>
            <span class="brand-sub">{{ messages.shell.brandSubtitle }}</span>
          </div>
        </button>
      </div>
      ...
      <nav class="header-nav">
        <NuxtLink to="/" class="nav-link" :class="{ active: route.path === '/' }">
          ...
          <span>{{ messages.shell.projects }}</span>
        </NuxtLink>
